...
async fn main() -> Result<()> {
    ...
    let openai_responses = Completions::new(OpenAIModels::Gpt5_4Pro, &openai_api_key, None, None)
    ...
    let openai_responses = Completions::new(OpenAIModels::Gpt5_4, &openai_api_key, None, None)
        .version("openai_responses")
